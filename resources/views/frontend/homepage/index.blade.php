...
<section style="padding-top: 6.5rem">
    <!--/.bg-holder-->
    <div class="bg-holder" style="background-image: url(images/background/with_art/ungu_gelap.png)">
    </div>
    <!--close of /.bg-holder-->
    <div class="container mt-6" data-aos="fade-up">
        <div class="row align-items-center">
            <div class="col-5 order-1 order-md-1 text-end">
                <img class="pt-0 pt-md-0 pt-lg-0 hero-img" src="https://holosbase.com/img/slide2/VR.png" alt="hero-header-VR-boy" />
            </div>
            <div class="col-7 colorder-0 text-md-start text-center py-6">
                ...
                <div class="text-center text-md-start">
                    <a class="btn btn-primary btn-lg me-md-4 mb-3 mb-md-0 border-0 primary-btn-shadow" href="#aboutus ">
                        Cari tahu yuk!
                    </a>
                    ...
                    {{--modal--}}
                    <a type="button" class="fw-medium text-white" data-bs-toggle="modal" data-bs-target="#popupVideo">
                    ...
                    <div class="modal fade" id="popupVideo" tabindex="-1" role="dialog" aria-labelledby="popupVideo" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body bg-transparent">
                                    <iframe class="rounded" style="" width="100%" height="300 px" src="https://drive.google.com/file/d/14Vpwng5mEL3yELjaVAnFxWii3mNaBTno/preview" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen">
                                    </iframe>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex align-items-start mb-5">
                    <div class="flex-1">
                        ...
                        <p>Indonesia 360 Tour adalah platform penyedia jasa tampilan
